...
export function ChatCTAButton() {
  ...
  return (
    <button
      onClick={toggleChat}
      className="focus-visible:ring-ring mt-6 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-primary to-teal-400 px-6 py-2.5 text-sm font-semibold text-white shadow-md transition-all hover:from-primary/90 hover:to-teal-500 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none"
    >
